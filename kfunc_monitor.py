...
int trace__kfunc(struct pt_regs* ctx)
{
	struct data_t data = {};
...
b = BPF(text = bpf_text)
b.attach_kretprobe(event="fib_table_insert", fn_name="trace__kfunc")
b.attach_kretprobe(event="fib_table_delete", fn_name="trace__kfunc")
